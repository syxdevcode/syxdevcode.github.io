...
consistent hashing 算法早在 1997 年就在论文 [Consistent hashing and random trees](https://dl.acm.org/doi/10.1145/258533.258660) 中被提出，目前在 cache 系统中应用越来越广泛；
...
<font color=#0099ff size=4 face="黑体">在这个环形空间中，如果沿着顺时针方向从对象的 key 值出发，直到遇见一个 cache ，那么就将该对象存储在这个 cache 上，因为对象和 cache 的 hash 值是固定的，因此这个 cache 必然是唯一和确定的。这样不就找到了对象和 cache 的映射方法了吗？！</font>
...
[https://github.com/wsq003/consistent-hash](https://github.com/wsq003/consistent-hash)
