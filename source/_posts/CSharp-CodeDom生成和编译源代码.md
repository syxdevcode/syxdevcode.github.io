---
title: CSharp-CodeDom生成和编译源代码
date: 2019-01-22 09:34:57
tags:
- DotNet
- CSharp
- CodeDOM
...
[在 CodeDOM 图中生成和编译源代码](https://docs.microsoft.com/zh-cn/dotnet/framework/reflection-and-codedom/generating-and-compiling-source-code-from-a-codedom-graph)

[CodeDomProvider Class](https://docs.microsoft.com/zh-cn/dotnet/api/system.codedom.compiler.codedomprovider?view=netframework-4.7.2)
